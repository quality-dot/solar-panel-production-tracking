...
export class DiscoveredMCPTool extends BaseTool {
    ...
    constructor(mcpTool, serverName, serverToolName, description, parameterSchema, timeout, trust, nameOverride) {
        super(nameOverride ?? generateValidName(serverToolName), `${serverToolName} (${serverName} MCP Server)`, description, Icon.Hammer, parameterSchema, true, // isOutputMarkdown
        false);
